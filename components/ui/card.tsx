...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={["rounded-lg border bg-card text-card-foreground shadow-lg hover:shadow-xl transition-all duration-400 ease-out-expo hover:-translate-y-1", className].filter(Boolean).join(" ")}
    {...props}
  />
));
